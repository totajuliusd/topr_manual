...
Examples of basic usage. For more examples on how to use each plotting function select the function name from the top navigation bar.
...
library(dplyr)
snps <- read.table("/Users/tota/github/topr/snps.out.txt", header=T, sep="\t")
